...
const DEFAULT_CHECKLIST: ChecklistItem[] = [
  ...
  { id: 'shift-2', text: 'Follow responsible alcohol service guidelines', completed: false, category: 'during-shift' },
  { id: 'shift-3', text: 'Ensure every guest gets an itemized copy of their bill', completed: false, category: 'during-shift' },
  { id: 'shift-4', text: 'Cash tips must not go into your register, instead be seperated at time of transaction and placed in the tip jar', completed: false, category: 'during-shift' },
